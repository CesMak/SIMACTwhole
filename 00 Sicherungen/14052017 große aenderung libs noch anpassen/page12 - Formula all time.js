...
function parse(id, content) {
	...
	content = ersetze_alles_zwischen(content, "-l(", ")");
...
function build_Head(id, ue, kat1, kat2, neuer_Head_nach_hier, name_neue_container_box) {
	...
	var fragment_h3 = create(`<h3>[<a id=` + id + ` href="javascript:add_click(` + id + `)">Add</a>,<a id=` + id + ` href="javascript:bearbeiten_click(` + id + `)">Edit</a>, <a href="` + "#divcontent" + id + `" data-toggle="collapse"> Collapse</a>` + ", Bewegen, Markieren, " + `<a id=` + id + ` href="javascript:delete_click(` + id + `)">Delete</a>` + "] YOUTUBE Links, WIKI Links, Querverweise?]" + "</h3>");
