...
function build_Head(id, ue, kat1, kat2) {
	...
	//iten, <a href="#content1" data-toggle="collapse"> Ausbldenden</a>, 
	var ueberschrift_unten_content = document.createTextNode("[Bearbeiten,"+`<a href="` +"#divcontent"+id+`" data-toggle="collapse"> Ausbldenden</a>`+", Bewegen, Markieren, Löschen]"); //TODO how to insert href in Ausblenden?
	...
	var fragment = create(`<h3>[Bearbeiten, <a href="` +"#divcontent"+id+`" data-toggle="collapse"> Ausbldenden</a>`+", Bewegen, Markieren, Löschen]"+"</h3>" );

	var position = document.getElementById("Containerboxneue"); //var tex = document.getElementById("eqadddd"); 	//document.getElementById("eqadddd").setAttribute("dd", "hallo");
	position.insertBefore(fragment, position.childNodes[0]); //	katex.render(String.raw `${formel}`, tex);
